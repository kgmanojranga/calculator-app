...
//                System.out.println(back);
            ...
            if (squareStr.endsWith(".0")){
                textField.setText(squareStr.replace(".0", ""));
            } else {
                textField.setText(squareStr);
            }
            ...
            if (squareRootStr.endsWith(".0")){
                textField.setText(squareRootStr.replace(".0", ""));
            } else {
                textField.setText(squareRootStr);
            }
        } else if (source == buttonReciprocal){
            String str = textField.getText();
            num1 = 1/ Double.parseDouble(str);
            String reciprocal = Double.toString(num1);
